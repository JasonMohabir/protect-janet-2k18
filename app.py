...
english_bot.train([
    "Hi there!",
    "Hello Jason. Or James. Or Janet. Or Katherine."
])
...
"Okay, but in the 80s laptops didn't exist. They were just large thick computers."
"Thick computers?.",
...
"The Berlin Wall obviously needs to come down!"
])
...
"I would say the Oregon Trail, but I don't to die of dysentery"
])
